    ...
    <section className="bg-white py-[40px] md:py-[72px]">
      <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%]">
        <div className={`grid grid-cols-1 ${data.image ? "lg:grid-cols-2" : ""} gap-10 lg:gap-[6%] items-stretch`}>
          {data.image ? (
            <div>
              <div className="h-full min-h-[360px] overflow-hidden rounded-xl border border-black/10 bg-[#f7f7f7] lg:min-h-full">
                <img
                  src={data.image}
                ...
                {items.map((item, index) => {
                  ...
                  return (
                    <article
                      ...
                      className="overflow-hidden rounded-xl border-b-2 border-brand-accent bg-white px-5 py-5 shadow-[0_12px_34px_rgba(0,0,0,0.07)] md:px-7 md:py-6"
                    >
