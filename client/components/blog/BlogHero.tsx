  ...
  return (
    <div className="bg-brand-dark pt-[30px] md:pt-[54px] pb-[30px] md:pb-[54px]">
      <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%]">
        <div className="flex flex-col items-center gap-8 text-center lg:flex-row lg:items-start lg:gap-[5%] lg:text-left">
          ...
          <div className="flex w-full justify-center lg:w-[30%] lg:justify-start lg:flex lg:items-center">
            <CallBox
              icon={Phone}
              title={phoneLabel}
