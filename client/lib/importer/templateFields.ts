...
export const practicePageFields: TemplateFieldDefinition[] = [
  ...
  // --- Hero section ---
  {
    key: "hero.h1Title",
    label: "Hero H1 Title",
    cmsPath: "content.hero.h1Title",
    required: false,
    type: "text",
    group: "Hero",
    helpText:
      "Small uppercase title above the main hero headline. Defaults to the source title when not mapped.",
  },
  {
    key: "hero.headline",
    label: "Hero Headline",
    cmsPath: "content.hero.headline",
    required: false,
    type: "text",
    group: "Hero",
    helpText: "Main large headline in the hero banner",
  },
  {
    key: "hero.highlightedText",
    label: "Highlighted Text",
    cmsPath: "content.hero.highlightedText",
    required: false,
    type: "text",
    group: "Hero",
    helpText: "Optional exact text to accent within the hero headline",
  },
  {
    ...
    type: "richtext",
    group: "Hero",
    helpText: "Paragraph text below the hero headline (HTML allowed)",
  },
  {
  ...
  },
  {
    ...
    cmsPath: "content.hero.heroImage",
    required: false,
    type: "image",
    group: "Hero",
    helpText: "Optional right-side image shown in the hero",
  },
  {
    key: "hero.heroImageAlt",
    label: "Hero Side Image Alt Text",
    cmsPath: "content.hero.heroImageAlt",
    required: false,
    type: "text",
    group: "Hero",
    helpText: "Alt text for the right-side hero image",
  },
  {
    key: "hero.consultationButtonText",
    label: "Consultation Button Text",
    cmsPath: "content.hero.consultationButtonText",
    required: false,
    type: "text",
    group: "Hero",
    helpText: "Optional second CTA button text",
  },
  {
    key: "hero.consultationButtonLink",
    label: "Consultation Button Link",
    cmsPath: "content.hero.consultationButtonLink",
    required: false,
    type: "text",
    group: "Hero",
    helpText: "Optional second CTA button URL",
  },
